...
The dataset "wheel_data" contains the data from the first sheet of the "HealthyHarborWaterWheelTotals2017-9-26.xlsx" file. This data has `r nrow(wheel_data)` rows, `r ncol(wheel_data)` columns and 215 observations. Besides, this dataset has 14 variables. Taking "weight_tons" as an example, dumpster1 collected 4.31 tons of trash on May 16th, 2014.

The dataset "precip_data" combines the data from the third and forth sheet of the "HealthyHarborWaterWheelTotals2017-9-26.xlsx" file. This data has `r nrow(precip_data)` rows, `r ncol(precip_data)` colums and 20 observations. Besides, this dataset has 3 variables. For example, the total precipetation in January 2016 is 3.23.
